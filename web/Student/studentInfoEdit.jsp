...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="/Student/studentIndex.jsp" class="logo">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="active"><a href="/selectStudentInfo/${student.studentNum}"><i class="fa fa-list-ol"></i> <span>学生信息</span></a></li>
                <li class="active"><a href="/listSelection/${student.studentNum}"><i class="fa fa-list-ol"></i> <span>选课情况</span></a></li>
                <li class="active"><a href="/listAllCourse/${student.studentNum}"><i class="fa fa-list-ol"></i> <span>选课操作</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" action="/updateStudentInfo/${student.studentNum}" method="post" onsubmit="return check(this)">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="studentNum" class="col-sm-2 control-label">学号 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentNum" placeholder="学号" name="studentNum" readonly="readonly" value=${student.studentNum}>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentName" placeholder="姓名" name="studentName" readonly="readonly" value=${student.studentName}>
                            </div>
                        </div>
