...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="/Admin/studentInsert.jsp" class="logo">
        ...
        <section class="content">
            ...
            <div class="container">
                <form class="form-horizontal" action="" method="post">
                    <h3>已选课程</h3>
                    <c:if test="${!empty selectionList}">
                        <table class="table table-bordered table-striped">
                            <tr>
                                <th style="width: 50%">课程号</th>
                                <th style="width: 50%">课程名</th>
                            </tr>

                            <c:forEach items="${selectionList}" var="course">
                                <tr>
