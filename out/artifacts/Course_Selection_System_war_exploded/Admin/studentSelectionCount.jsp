            ...
            <div class="container">
                ...
                <table class="table table-bordered table-striped">
                    <tr>
                        ...
                        <th style="width: 40%">选课数量</th>
                    </tr>

                    <c:forEach items="${selectionCount}" var="selectionCount">
                        <tr>
                            <td><a href="/studentSelection/${selectionCount.key.studentNum}">${selectionCount.key.studentNum}</a></td>
                            <td>${selectionCount.key.studentName}</td>
                            <td>${selectionCount.value}</td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
