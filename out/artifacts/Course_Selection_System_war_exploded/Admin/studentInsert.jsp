    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" action="/insertStudent" method="post" onsubmit="return check(this)">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="studentNum" class="col-sm-2 control-label">学号 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentNum" placeholder="学号" name="studentNum"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentIdnums" placeholder="身份证号" name="studentIdnums"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentClass" placeholder="班级" name="studentClass"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentSex" placeholder="性别" name="studentSex"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentAddress" placeholder="地址" name="studentAddress"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentNative" placeholder="籍贯" name="studentNative"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="tel" class="form-control" id="studentTel" placeholder="电话" name="studentTel"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentHobby" placeholder="爱好" name="studentHobby"/>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
