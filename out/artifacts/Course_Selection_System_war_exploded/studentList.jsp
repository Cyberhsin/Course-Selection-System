...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="container">
                <h3>所有用户 <a href="studentInsert.jsp" type="button" class="btn btn-primary btn-sm">添加</a></h3>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${studentList}" var="student">
                            <tr>
                                ...
                                <td>
                                    <a href="/selectStudentInfo/${student.studentNum}" type="button" class="btn btn-sm btn-success">详情</a>
                                    <a href="/updateStudent/${student.studentNum}" type="button" class="btn btn-sm btn-warning">修改</a>
