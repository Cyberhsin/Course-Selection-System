    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="/insertStudent">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="studentNum" class="col-sm-2 control-label">学号</label>

                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentNum" placeholder="学号" name="studentNum">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentPwd" placeholder="密码" name="studentPwd">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="studentIdNum" class="col-sm-2 control-label">身份证</label>

                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentIdNum" placeholder="身份证" name="studentIdNum">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentClass" placeholder="班级" name="studentClass">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentSex" placeholder="性别" name="studentSex">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentAddress" placeholder="地址" name="studentAddress">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentNative" placeholder="籍贯" name="studentNative">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentTel" placeholder="电话" name="studentTel">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="studentHobby" placeholder="爱好" name="studentHobby">
                            </div>
                        </div>
